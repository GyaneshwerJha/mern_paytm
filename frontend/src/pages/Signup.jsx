    ...
    <div className="h-screen flex justify-center items-center bg-gray-200">
      <div className="rounded-2xl p-6 flex flex-col justify-center bg-white drop-shadow-lg">
        <div className="text-center">
          ...
          <p className="m-auto w-5/6 mb-2 text-gray-700">
            Enter your information to create an account
          </p>
        </div>
        <label htmlFor="username">Username</label>
        <input
          className="border-2 p-1 mb-2 mt-1"
          type="text"
          value={username}
        ...
        <button
          ...
          className="border-black border-2 rounded-xl bg-black text-white w-1/2 m-auto hover:bg-teal-400"
        >
          Sign Up
        </button>
        <div className="flex justify-center">
          <p className="mr-2">Already have an account?</p>
          <a onClick={navigateToSignin} className="underline cursor-pointer">
            Sign-in
          </a>
        </div>
      </div>
